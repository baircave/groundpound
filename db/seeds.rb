...
guest = User.create!(username: "guest", password: "asdfasdf", location: "New York, NY", bio: "I'm your friendly neighborhood Guest user! If you're checking out Groundpound for the first time, enjoy your stay!")
...
guest.profile_photo.attach(io: prof_photo, filename: 'triple-shirt.jpg')
guest.cover_photo.attach(io: cover_photo, filename: 'NN.jpeg')
...
c3 = Comment.create!(body: "i was at that show but i don't remember any of it so i assume it was dope", author_id: guest.id, track_id: t10.id)
c4 = Comment.create!(body: "what were you wearing?", author_id: u1.id, track_id: t10.id)
c5 = Comment.create!(body: "i had a guy fieri haircut and only wore turtlenecks that year", author_id: guest.id, track_id: t10.id)

Follow.create!(artist_id: guest.id, user_id: u1.id)
Follow.create!(artist_id: guest.id, user_id: u2.id)
Follow.create!(artist_id: guest.id, user_id: u3.id)
Follow.create!(artist_id: guest.id, user_id: u5.id)
Follow.create!(artist_id: guest.id, user_id: u6.id)
Follow.create!(artist_id: guest.id, user_id: u7.id)
Follow.create!(artist_id: guest.id, user_id: u8.id)
Follow.create!(artist_id: guest.id, user_id: u9.id)

Follow.create!(artist_id: u1.id, user_id: guest.id)
Follow.create!(artist_id: u8.id, user_id: guest.id)
Follow.create!(artist_id: u9.id, user_id: guest.id)
Follow.create!(artist_id: u5.id, user_id: guest.id)

Like.create!(track_id: t16.id, user_id: guest.id)
Like.create!(track_id: t15.id, user_id: guest.id)
Like.create!(track_id: t14.id, user_id: guest.id)
Like.create!(track_id: t13.id, user_id: guest.id)

Repost.create!(track_id: t16.id, user_id: guest.id)
Repost.create!(track_id: t15.id, user_id: guest.id)
Repost.create!(track_id: t14.id, user_id: guest.id)
Repost.create!(track_id: t13.id, user_id: guest.id)
